...
class _ActivityTrackerViewState extends State<ActivityTrackerView> {
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor = isDark ? Colors.grey[900] : TColor.white;
    final textColor = isDark ? Colors.white : TColor.black;
    final containerColor = isDark ? Colors.grey[800] : TColor.white;
        ...
        leading: InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                color: isDark ? Colors.grey[700] : TColor.lightGray,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(colors: [
                    isDark 
                        ? TColor.primaryColor2.withOpacity(0.2)
                        ...
                        items: ["Weekly", "Monthly"]
                            .map((name) => DropdownMenuItem(
                                  ...
                                  child: Text(
                                    name,
                                    style: TextStyle(
                                        color: isDark ? Colors.white70 : TColor.gray,
                                        fontSize: 14),
                                  ),
                                ))
                            .toList(),
                  ...
                  BarChartData(
                    barTouchData: BarTouchData(
                      touchTooltipData: BarTouchTooltipData(
                        tooltipBgColor: isDark ? Colors.grey[700]! : Colors.grey,
  ...
  Widget getTitles(double value, TitleMeta meta, bool isDark) {
    var style = TextStyle(
      color: isDark ? Colors.white70 : TColor.gray,
      fontWeight: FontWeight.w500,
      fontSize: 12,
